...
@asset(required_resource_keys={"postgres"}, group_name="trajectory_assets", compute_kind="pkl")
def trajectory_pickle_file(trajectory_dataframe: gpd.GeoDataFrame) -> str:
    """ Saves the trajectories to file and returns the path """
    path = 'dagster_ais/data/trajectories/trips.pkl'
    trajectory_dataframe.to_pickle(path)
    return path
