...
from test_dagster.ops.trajectory_ops import collect_messages2, create_dataframe, create_tracks, save_to_pickle, create_geo_dataframe, save_to_postgis
...
def generate_trajectories():
    ...
    collect = collect_messages2(interval)
